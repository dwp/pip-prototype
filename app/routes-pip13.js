module.exports = function(app){
   ...
   *******************/
   ...
   app.post('/pip13/helper', function (req, res) {
     ...
     req.session['pip13-helper']['helper' + req.body.helper] = req.body.helper;
   ...
   *******************/
   ...
   app.post('/pip13/nationality', function (req, res) {
     ...
     req.session['pip13-nationality']['britishCitizen' + req.body.britishCitizen] = req.body.britishCitizen;
     req.session['pip13-nationality']['livingUK' + req.body.livingUK]             = req.body.livingUK;
     req.session['pip13-nationality']['beenAbroad' + req.body.beenAbroad]         = req.body.beenAbroad;
   ...
   *******************/
   app.get('/pip13/check-and-change', function (req, res) {
     res.render('pip13/check-and-change', {
       ...
       conditionDetails              : req.session['pip13-conditionDetails'],
       medications                   : req.session['pip13-medications'],
       manageMedications             : req.session['pip13-manageMedications'],
       treatments                    : req.session['pip13-treatments'],
       manageTreatments              : req.session['pip13-manageTreatments'],
       sideEffects                   : req.session['pip13-sideEffects'],
       conditioneffects              : req.session['pip13-conditioneffects'],
       hcpcondition                  : req.session['pip13-hcp-condition'],
       hcpcondition2                 : req.session['pip13-hcp-condition-2'],
       healthcareprofessional        : req.session['pip13-healthcareprofessional'],
       submitEvidence                : req.session['pip13-submitEvidence'],
       specialAids                   : req.session['pip13-specialAids'],
       gettingAround                 : req.session['pip13-gettingAround'],
       seeing                        : req.session['pip13-seeing'],
       hearing                       : req.session['pip13-hearing'],
       speaking                      : req.session['pip13-speaking'],
       gettingUp                     : req.session['pip13-gettingUp'],
       toilet                        : req.session['pip13-toilet'],
       washing                       : req.session['pip13-washing'],
       gettingDressed                : req.session['pip13-gettingDressed'],
       preparingandcookingfood       : req.session['pip13-preparingandcookingfood'],
       eatinganddrinking             : req.session['pip13-eatinganddrinking'],
       goingOut                      : req.session['pip13-goingOut'],
       gettingOn                     : req.session['pip13-gettingOn'],
       goingSomewhereNeverbeenBefore : req.session['pip13-goingSomewhereNeverbeenBefore'],
       goingSomewherebeenBefore      : req.session['pip13-goingSomewherebeenBefore'],
       understandingq                : req.session['pip13-understanding-q'],
       money                         : req.session['pip13-money'],
       additionalInfo                : req.session['pip13-additionalInfo']
     });
   });
